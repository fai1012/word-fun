        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="relative w-full max-w-sm bg-cream border-4 border-coffee rounded-3xl p-6 shadow-[8px_8px_0px_0px_rgba(93,64,55,0.3)] transform transition-all animate-in zoom-in-95 duration-200">
                ...
                <div className="flex flex-col items-center text-center pt-2">
                    ...
                    {/* Title */}
                    <h3 className="text-xl font-bold text-coffee mb-3 font-rounded">
                        {title}
                    </h3>
                    ...
                    <div className="flex gap-3 w-full">
                        <button
                            onClick={onClose}
                            className="flex-1 py-3 bg-white text-coffee font-bold text-sm rounded-xl border-2 border-coffee/10 hover:bg-coffee/5 transition-colors"
                        >
                            {cancelText}
                        </button>
                        <button
                            ...
                            className={`flex-1 py-3 text-white font-bold text-sm rounded-xl border-2 border-coffee shadow-[2px_2px_0px_0px_rgba(93,64,55,0.2)] hover:shadow-none hover:translate-x-[1px] hover:translate-y-[1px] transition-all ${isDestructive
                                    ? 'bg-salmon'
                                    : 'bg-matcha'
                                }`}
                        >
